...
CREATE TABLE `orderedproduct` (
  ...
  KEY `orderedproduct_fk_productdetailis_idx` (`productdetailid`),
  CONSTRAINT `orderedproduct_fk_productdetailis` FOREIGN KEY (`productdetailid`) REFERENCES `productdetails` (`productdetailid`)
...
-- Dump completed on 2024-09-11 20:32:25
